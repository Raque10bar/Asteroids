...
public class Spaceship extends GameObject
{
	 ...
	 *	@param score score.
	 */
	private Spaceship (Point location, double velocityX, double velocityY, int radius, double direction, boolean up, int score, Color color, String name)
	{
	...
	public boolean equals(Object o) {
		...
		if (o instanceof Spaceship) {
			ship = (Spaceship) o;
			if (this.getAddress().equals(ship.getAddress())) {
				return true;
			}
		}
		return false;
